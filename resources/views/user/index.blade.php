			...
			<div class="card-body pb-0">
				...
				<div class="grid grid-cols-12 items-stretch">
					<div class="col-span-12 lg:col-span-6 self-center">
						<h5 class="text-15 text-gray-600 dark:text-gray-100">Operator List <span class="text-gray-500 font-normal ml-2 dark:text-zinc-100">({{$data->count()}})</span></h5>
					</div>
					<div class="col-span-12 lg:col-span-6">
						<div class="flex flex-wrap items-center gap-2 mt-5 lg:mt-0 lg:justify-end">
							<div>
								<a href="{{route('user.create')}}" class="btn bg-gray-50 border-gray-50 dark:bg-zinc-600/50 dark:border-zinc-600 dark:text-gray-100"><i class="bx bx-plus me-1"></i> Tambah Operator</a>
							</div>
							<div>
