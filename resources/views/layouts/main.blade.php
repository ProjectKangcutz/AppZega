...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('minia/images/favicon.ico')}}" />
        ...
        <link href="{{asset('minia/libs/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.css')}}" rel="stylesheet" type="text/css">
     ...
     <!-- DataTables -->
        <link href="{{asset('minia/libs/datatables.net-bs4/css/dataTables.bootstrap4.min.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{asset('minia/libs/datatables.net-buttons-bs4/css/buttons.bootstrap4.min.css')}}" rel="stylesheet" type="text/css" />
